...
function Banner() {
  ...
  return (
    <div className="relative overflow-hidden bg-gray-900 text-white py-16 md:py-24 px-6 md:px-12">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              <a href="https://www.facebook.com/profile.php?id=100072563070175" target="_blank" rel="noopener noreferrer"
                className="hover:text-cyan-400 transition-colors transform hover:-translate-y-1">
            ...
            >
              <motion.button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-cyan-500 rounded-lg font-medium hover:bg-cyan-600 transition-all shadow-lg hover:shadow-xl"
              >
          ...
          <div className="flex-1 flex flex-col items-center w-full">
            ...
            >
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-cyan-400 shadow-2xl group">
                <img
                  src={profileImage}
                ...
                />
                {/* Glow effect */}
                <div className="absolute inset-0 rounded-full shadow-[0_0_30px_15px_rgba(34,211,238,0.3)] opacity-0 group-hover:opacity-70 transition-opacity duration-500"></div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {skills.map((skill, index) => (
                  <motion.div
                    ...
                    className={`p-4 rounded-xl ${skill.bg} backdrop-blur-sm border border-gray-700 shadow-md transition-all duration-300 ${activeSkill === index ? 'ring-2 ring-cyan-400 scale-105' : ''
                      }`}
                  >
